    ...
    public Cube SimpleMove(Cube cube, string mv)
    {
        switch (mv)
        {
            ...
            case "L2":
                ...
                break;
            case "R":
                cube = this.stdMoves.MoveR(cube);
                break;
            case "R'":
                cube = this.stdMoves.MoveRPrime(cube);
                break;
            case "R2":
                cube = this.stdMoves.MoveR2(cube);
                break;
            case "F":
                cube = this.stdMoves.MoveF(cube);
                break;
            case "F'":
                cube = this.stdMoves.MoveFPrime(cube);
                break;
            case "F2":
                cube = this.stdMoves.MoveF2(cube);
                break;
            case "y":
